...
<!DOCTYPE html>
<html>
<?php $title="IS Project Bloodbank | home page"; ?>
<?php require 'head.php'; ?>
<body style="background-color: #f47174">
   ...
   <?php require 'message.php'; ?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <i class="fa fa-envelope"> </i> <a > Shiva&Pavan@gmail.com</a><br><br>
                        <i class="fa fa-mobile"> </i> <a > +91 12345678901</a><br><br>
                    </div>
                </div>
            </div>
            </div>
    ...
    <div class="col-lg-12">
                <div class="card">
                    <div class="card-header text-center">Youtube Video Links</div>
                    <div class="card-body">
                    <iframe width="550" height="315" src="https://www.youtube.com/embed/hay1yJmZIPM" > </iframe>
                    <iframe src="https://www.youtube.com/embed/kJf_4N2OLjw" width="550" height="315" > </iframe>   
                    </div>
                    </div>
                    </div>
                    </div>
